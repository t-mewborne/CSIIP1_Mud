...
object Main {
	def main(args: Array[String]): Unit = {
	  ...
	  println("Hello " + input + "! Welcome! Type \"help\" at any time for a list of possible commands.\nYou are currently in the " + player1.currentLocation.getName + ", " + player1.currentLocation.description.toLowerCase() + "\n")
